...
\begin{table}[!hbtp]
	...
	\begin{center}
		...
		\begin{tabular}{|c|p{0.7\textwidth}|}			
			...
			\\
			\cellcolor{gray!10}{\textbf{Desc.}} 
			& Implementar guardado a ficheros externos del tipo a convenir, generalmente de valores separados por comas (\texttt{.csv}), de los datos generados por las aeronaves en vuelo: distancia recorrida, tiempo en vuelo, puntos de ruta navegados, etc.  
			\\
			\hline		
		\end{tabular}
	\end{center}
