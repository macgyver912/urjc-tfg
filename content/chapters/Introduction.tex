...
Además, las estrategias de optimización de las operaciones aéreas junto con los planes de reducción de emisiones de efecto invernadero promueven la búsqueda de rutas cada vez más eficientes, lo que conlleva en ciertos casos a acortar trayectorias y a concentrar más aún el tráfico en determinadas áreas. Es por ello que que, cada vez más, se emplean herramientas informáticas que ayudan a evaluar y mejorar la calidad de las operaciones aéreas mediante simulaciones.
