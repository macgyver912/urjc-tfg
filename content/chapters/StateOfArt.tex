...
\begin{table}[!hbtp]
	\begin{center}
		\caption[Síntesis de funcionalidades de los simuladores actuales.]{Síntesis de funcionalidades de los simuladores actuales.}
		\label{tab:ResumenSimuladores}
		\hspace*{-2cm}
		\begin{tabular}{|r|c|c|c|c|c|l|}
			\hline % Title
			\rule[-1ex]{0pt}{2.5ex} 
			\diagbox[innerwidth=\textwidth*1/5]{\textbf{Función}}{\textbf{Simulador}}
			& $\;\;\;\;$\textbf{ATC-SIM}$\;\;\;\;$
			& \begin{tabular}{@{}c@{}}
				\textbf{Global ATC} \\ 
				\textbf{Simulator}
			...
			& \begin{tabular}{@{}c@{}}
			  ...
			  \end{tabular}
			& \diagbox[dir=NE,innerwidth=\textwidth*1/5]{\textbf{Function}}{\textbf{Simulator}}
			\\ 
			% Test column width
			\hline 
			\rule[-1ex]{0pt}{2.5ex}  
