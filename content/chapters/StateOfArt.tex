...
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.9\linewidth]{images/content/STCA.jpg}
%		\caption[Sistema de Alerta de Conflicto a Corto Plazo (STCA).]{Sistema de Alerta de Conflicto a Corto Plazo (STCA) \citeFig{STCA_url}.}
%		\label{fig:STCA}
%	\end{subfigure}%
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.9\linewidth]{images/content/TCAS.jpg}
...
%		\label{fig:TCAS}
%	\end{subfigure}
%	\caption{Sistemas de prevención de conflictos STCA y TCAS.}
%	\label{fig:STCA_TCAS}
%\end{figure}
