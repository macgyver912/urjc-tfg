...
\begin{itemize}
	...
	\item Espacio aéreo inferior o Región de Información de Vuelo, FIR (\textit{Flight Information Region}). Comprende desde la superficie del terreno (GND, \textit{Ground}) hasta FL245.
...
\begin{figure}[!hbtp]
	\centering
	\includegraphics[width=0.85\linewidth]{images/content/AreasATC.jpg}
