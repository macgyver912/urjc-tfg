...
La interfaz de control puede ser mediante texto o ratón, tal y como se muestra en la Figura \ref{ATC-GATC_input}.
...
Como puede apreciarse en la Figura \ref{fig:ATC-openScopeATC}, se trata del simulador más completo de todos y también el más complejo de usar por la cantidad de comandos que soporta, siendo tan diversos que merece la pena revisarlos en su página oficial de GitHub \cite{ATC-openScopeATC-Git}, a la que redirige desde la ayuda del simulador. 
