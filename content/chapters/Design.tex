...
Desde sus inicios ha contado con varios tipos de licencia, siendo actualmente la licencia Unity Personal gratuita si no se obtienen ingresos superiores a \$\SI{200000}{} brutos anuales con las aplicaciones desarrolladas . A cambio, Unity introduce automáticamente su logotipo en el \textit{splash screen} de inicio.

//TODO
\begin{figure}[!hbtp]
	\centering
	\includegraphics{example-image-a}
	%\includegraphics[width=1.0\linewidth]{images/content/Unity6.jpg}
	\caption{Vista general del entorno Unity 6.}
	\label{fig:Unity6}
\end{figure}	

La calidad y el renderizado 3D que lleva a cabo es tan bueno que se está empleando incluso para cortometrajes de animación 3D, gracias también por su gran motor de cinemáticas y movimientos de personajes.

Se ha empleado este entorno de desarrollo de videojuegos para todo el sistema de visualización y ejecución de la aplicación.
...
Visual Studio es un entorno de desarrollo de integrado (IDE, \textit{Integrated Development Environment}), orientado sobre todo para programación en lenguajes C y C++, creado por Microsoft y que presenta varias versiones asociadas a distintos planes. La versión empleada en este caso ha sido Visual Studio Community 2022, siendo la versión gratuita para personas individuales sin ánimo de lucro con el desarrollo realizado con esta herramienta. Tan sólo es necesario estar registrado \cite{VisualStudio}.
...
\begin{figure}[!hbtp]
	...
	\caption{Vista general del IDE VisualStudio.}
...
Para este caso concreto, todo el código desarrollado para la aplicación ha sido realizado mediante el uso de Visual Studio, tal y como puede verse en la Figura \ref{fig:VisualStudio}. 
